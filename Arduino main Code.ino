...
#define echo A2    //Echo pin of ultrasonic sensor
#define trigger A3 //Trigger pin of ultrasonic sensor
...
delay(100);
     ...
     if(bt_ir_data == 8){mode=0; Stop();}    //Manual and IR Remote Control  
else if(bt_ir_data == 9){mode=1; Speed=130;} //Auto Line Follower
else if(bt_ir_data ==10){mode=2; Speed=255;} //Auto Obstacle Avoiding 
